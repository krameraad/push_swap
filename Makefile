...
test: all norm valgrind test_error test_identity test_3 test_5 test_100 test_500
...
valgrind:
	@echo ""
	valgrind --leak-check=full ./$(NAME) $(TEST_5)
...
test_3: all $(ARGGEN)
	...
	./$(NAME) $(TEST_3) | wc -l
	./$(NAME) "$(shell ./arg_gen -s 3 -p 4 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 3 -p 4 -d 10 -r)"
	./$(NAME) "$(shell ./arg_gen -s 3 -p 4 -d 10 -r)" | wc -l
	./$(NAME) "$(shell ./arg_gen -s 3 -p 5 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 3 -p 5 -d 10 -r)"
	./$(NAME) "$(shell ./arg_gen -s 3 -p 5 -d 10 -r)" | wc -l
	./$(NAME) "$(shell ./arg_gen -s 3 -p 6 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 3 -p 6 -d 10 -r)"
...
test_5: all $(ARGGEN)
	...
	./$(NAME) $(TEST_5) | wc -l
	./$(NAME) "$(shell ./arg_gen -s 5 -p 7 -d 50 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 5 -p 7 -d 50 -r)"
	./$(NAME) "$(shell ./arg_gen -s 5 -p 7 -d 50 -r)" | wc -l
	./$(NAME) "$(shell ./arg_gen -s 5 -p 8 -d 50 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 5 -p 8 -d 50 -r)"
	./$(NAME) "$(shell ./arg_gen -s 5 -p 8 -d 50 -r)" | wc -l
	./$(NAME) "$(shell ./arg_gen -s 5 -p 9 -d 50 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 5 -p 9 -d 50 -r)"
	./$(NAME) "$(shell ./arg_gen -s 5 -p 9 -d 50 -r)" | wc -l

test_100: all $(ARGGEN)
	@echo "\033[1;4;44m\n\tTest: 100\033[0m"
	@echo "Commands omitted for visual clarity"
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 10 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 100 -p 10 -d 10 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 10 -d 10 -r)" | wc -l
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 11 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 100 -p 11 -d 10 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 11 -d 10 -r)" | wc -l
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 12 -d 10 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 100 -p 12 -d 10 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 100 -p 12 -d 10 -r)" | wc -l
	
test_500: all $(ARGGEN)
	@echo "\033[1;4;44m\n\tTest: 500\033[0m"
	@echo "Commands omitted for visual clarity"
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 13 -d 5 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 500 -p 13 -d 5 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 13 -d 5 -r)" | wc -l
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 14 -d 5 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 500 -p 14 -d 5 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 14 -d 5 -r)" | wc -l
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 15 -d 5 -r)" \
	| ./$(CHECKER) "$(shell ./arg_gen -s 500 -p 15 -d 5 -r)"
	@./$(NAME) "$(shell ./arg_gen -s 500 -p 15 -d 5 -r)" | wc -l

.PHONY: all clean fclean re test \
norm test_error test_identity test_3 test_5 test_100 test_500
